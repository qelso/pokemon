 ...
 */
const documents = {
    "query getOpponentPokemons($id: Int =1) {\n    pokemon_v2_pokemon(where: {id: {_eq: $id}}) {\n      name\n      id\n      pokemon_v2_pokemonsprites {\n        sprites(path: \"front_default\")\n      }\n      pokemon_v2_pokemontypes {\n        pokemon_v2_type {\n          name\n        }\n      }\n      pokemon_v2_pokemonstats {\n        base_stat\n        pokemon_v2_stat {\n          name\n        }\n      }\n    }\n  }\n  ": types.GetOpponentPokemonsDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query getOpponentPokemons($id: Int =1) {\n    pokemon_v2_pokemon(where: {id: {_eq: $id}}) {\n      name\n      id\n      pokemon_v2_pokemonsprites {\n        sprites(path: \"front_default\")\n      }\n      pokemon_v2_pokemontypes {\n        pokemon_v2_type {\n          name\n        }\n      }\n      pokemon_v2_pokemonstats {\n        base_stat\n        pokemon_v2_stat {\n          name\n        }\n      }\n    }\n  }\n  "): (typeof documents)["query getOpponentPokemons($id: Int =1) {\n    pokemon_v2_pokemon(where: {id: {_eq: $id}}) {\n      name\n      id\n      pokemon_v2_pokemonsprites {\n        sprites(path: \"front_default\")\n      }\n      pokemon_v2_pokemontypes {\n        pokemon_v2_type {\n          name\n        }\n      }\n      pokemon_v2_pokemonstats {\n        base_stat\n        pokemon_v2_stat {\n          name\n        }\n      }\n    }\n  }\n  "];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetPokemonDetails($pokemon: String = \"\") {\n  pokemon_v2_pokemon(where: {name: {_eq: $pokemon}}) {\n    name\n    pokemon_v2_pokemontypes {\n      pokemon_v2_type {\n        name\n      }\n    }\n    id\n    height\n    weight\n    base_experience\n    pokemon_v2_pokemonstats {\n      base_stat\n      pokemon_v2_stat {\n        name\n      }\n    }\n    pokemon_v2_pokemonmoves(limit: 4) {\n      pokemon_v2_move {\n        name\n      }\n    }\n    pokemon_v2_pokemonsprites {\n      sprites\n    }\n    pokemon_v2_pokemonabilities {\n      pokemon_v2_ability {\n        name\n      }\n    }\n    pokemon_v2_pokemonforms {\n      name\n    }\n  }\n}\n  "): (typeof documents)["query GetPokemonDetails($pokemon: String = \"\") {\n  pokemon_v2_pokemon(where: {name: {_eq: $pokemon}}) {\n    name\n    pokemon_v2_pokemontypes {\n      pokemon_v2_type {\n        name\n      }\n    }\n    id\n    height\n    weight\n    base_experience\n    pokemon_v2_pokemonstats {\n      base_stat\n      pokemon_v2_stat {\n        name\n      }\n    }\n    pokemon_v2_pokemonmoves(limit: 4) {\n      pokemon_v2_move {\n        name\n      }\n    }\n    pokemon_v2_pokemonsprites {\n      sprites\n    }\n    pokemon_v2_pokemonabilities {\n      pokemon_v2_ability {\n        name\n      }\n    }\n    pokemon_v2_pokemonforms {\n      name\n    }\n  }\n}\n  "];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
